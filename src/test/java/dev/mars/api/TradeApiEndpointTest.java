...
/**
 * Integration tests for the Trade API endpoints.
 * These tests use a shared server instance to avoid port conflicts.
 */
public class TradeApiEndpointTest {

    private static final int TEST_PORT = 7072; // Using a different port to avoid conflicts
    ...
    public static void setupClass() {
        System.out.println("[DEBUG_LOG] Starting server for all tests");
        ...
        // Get the data source from AppConfig
        dataSource = (JdbcDataSource) appConfig.getDataSource();
    ...
    public void setup() throws SQLException {
        ...
        System.out.println("[DEBUG_LOG] Resetting database");
